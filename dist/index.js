...
function getAll (spreadsheetId) {
  ...
  return new Promise(function (resolve, reject) {
    _this.sheetsAPI.spreadsheets.get({
      auth: _this.client,
    ...
    return new Promise(function (resolve, reject) {
      _this.sheetsAPI.spreadsheets.values.batchGet({
        auth: _this.client,
        spreadsheetId: spreadsheetId,
        ranges: data.sheets.map(function (s) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", fetch("https://docs.googleapis.com/v1/documents/".concat(docId, ":batchUpdate?access_token=").concat(auth.access_token), request));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            output = {};
            _context.next = 3;
            return this.sheets.getAll(docId);
